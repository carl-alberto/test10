...
Installing "A Test 10" can be done either by searching for "A Test 10" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
