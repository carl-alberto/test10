...
class A_Test_10 {
	...
	/**
	 * The single instance of A_Test_10.
	 *
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
...
//		$custom->register_cpt1();
	...
	public function load_localisation() {
		load_plugin_textdomain( 'a-test-10', false, dirname( plugin_basename( $this->file ) ) . '/languages/' );
	...
	/**
	 * Main A_Test_10 Instance.
	 *
	 * Ensures only one instance of A_Test_10 is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see A_Test_10()
	 ...
	 * @param string $version Version of this plugin.
	 * @param array  $pluginoptions Contains various options for the plugin.
	 * @return Main A_Test_10 instance
	 */
