 ...
 *
 * @package A Test 10 \ Main Functionalities
 * @author Carl Alberto
 * @since 1.0.0
 */
...
class A_Test_10_Main {
	...
	public function register_post_type( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new A_Test_10_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new A_Test_10_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
